...
namespace LibBlePeripheral.LinuxBluezServer.Core
{
    ...
    {
        Task ReleaseAsync();
        Task<bool> AuthorizeServiceAsync(string sender, string path, string uuid);
        Task RequestPinCodeAsync(string sender, string path);
        Task DisplayPinCodeAsync(string sender, string path, string pinCode);
        Task RequestPasskeyAsync(string sender, string path);
        Task DisplayPasskeyAsync(string sender, string path, uint passkey, ushort entered);
        Task RequestConfirmationAsync(string sender, string path, uint passkey);
        Task RequestAuthorizationAsync(string sender, string path);
        Task AuthorizeAsync(string sender, string path);
        Task CancelAsync();
    }
