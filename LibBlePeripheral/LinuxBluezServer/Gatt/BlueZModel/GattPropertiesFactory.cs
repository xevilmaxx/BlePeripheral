...
namespace LibBlePeripheral.LinuxBluezServer.Gatt.BlueZModel
{
    ...
    {
        public static GattService1Properties CreateGattService(
        ...
        public static GattCharacteristic1Properties CreateGattCharacteristic(
            GattCharacteristicDescription characteristic
        )
        {
            var characteristicProperties = new GattCharacteristic1Properties
            {
                UUID = characteristic.UUID,
                Flags = CharacteristicFlagConverter.ConvertFlags(characteristic.Flags)
            };

            return characteristicProperties;
        }

        public static GattDescriptor1Properties CreateGattDescriptor(
