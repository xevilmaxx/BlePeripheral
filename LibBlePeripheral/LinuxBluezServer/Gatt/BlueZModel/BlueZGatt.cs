...
namespace LibBlePeripheral.LinuxBluezServer.Gatt.BlueZModel
{
    ...
    class LEAdvertisement1Properties
    {
        ...
        private IDictionary<string, object> _ManufacturerData = default(IDictionary<
            string,
            object
        >);
    ...
    static class LEAdvertisement1Extensions
    {
        public static Task<string> GetTypeAsync(this ILEAdvertisement1 o) =>
            o.GetAsync<string>("Type");

        public static Task<string[]> GetServiceUUIDsAsync(this ILEAdvertisement1 o) =>
            o.GetAsync<string[]>("ServiceUUIDs");

        public static Task<IDictionary<string, object>> GetManufacturerDataAsync(
            this ILEAdvertisement1 o
        ) => o.GetAsync<IDictionary<string, object>>("ManufacturerData");

        public static Task<string[]> GetSolicitUUIDsAsync(this ILEAdvertisement1 o) =>
            o.GetAsync<string[]>("SolicitUUIDs");

        public static Task<IDictionary<string, object>> GetServiceDataAsync(
            this ILEAdvertisement1 o
        ) => o.GetAsync<IDictionary<string, object>>("ServiceData");

        public static Task<bool> GetIncludeTxPowerAsync(this ILEAdvertisement1 o) =>
            o.GetAsync<bool>("IncludeTxPower");
    }
}
